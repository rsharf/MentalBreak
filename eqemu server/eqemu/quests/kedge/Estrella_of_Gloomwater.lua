...
-- Estrella_of_Gloomwater (64013) Spawns #The_Fabled_Estrella_of_Gloomwater (ID: 64098) exactly 15 seconds after death
...
function event_death_complete(e)
    ...
    if spawner and spawner.valid then
        spawner:CastToNPC():SetEntityVariable("fabled_id", "64098")
    end
end
