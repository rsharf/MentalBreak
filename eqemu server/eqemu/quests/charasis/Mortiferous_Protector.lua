...
-- #Mortiferous_Protector (105157) Spawns #The_Fabled_Mortiferous_Protector (ID: 105289) exactly 15 seconds after death
...
function event_death_complete(e)
    ...
    if spawner and spawner.valid then
        spawner:CastToNPC():SetEntityVariable("fabled_id", "105289")
    end
end
