...
-- reclusive_ghoul_magus (63086) Spawns The_Fabled_Reclusive_Ghoul_Magus (ID: 63110) exactly 15 seconds after death
...
function event_death_complete(e)
    ...
    if spawner and spawner.valid then
        spawner:CastToNPC():SetEntityVariable("fabled_id", "63110")
    end
end
