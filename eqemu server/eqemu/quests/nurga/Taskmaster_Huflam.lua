...
-- #Taskmaster_Huflam (107153) Spawns #The_Fabled_Taskmaster_Huflam (ID: 107158) exactly 15 seconds after death
...
function event_death_complete(e)
    ...
    if spawner and spawner.valid then
        spawner:CastToNPC():SetEntityVariable("fabled_id", "107158")
    end
end
