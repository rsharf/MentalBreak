-- Rivervale Instance Encounter (version 100)
-- Named NPCs spawn via database spawn2 (version=100)
-- Lockout set on Sheriff_Roglio (ID 19058) death

function Boss_Death(e)
    eq.set_global("inst_rivervale_lockout", tostring(os.time()), 2, "H24")
...
function event_encounter_load(e)
    eq.register_npc_event('instance_boss', Event.death_complete, 19058, Boss_Death)
    eq.register_npc_event('instance_boss', Event.combat, 19058, Boss_Combat)
