...
-- Iksar_Bandit_Lord (79116) Spawns The_Fabled_Iksar_Bandit_Lord (ID: 79150) exactly 15 seconds after death
...
function event_death_complete(e)
    ...
    if spawner and spawner.valid then
        spawner:CastToNPC():SetEntityVariable("fabled_id", "79150")
    end
end
