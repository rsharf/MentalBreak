...
function event_spawn(e)
	-- Skip zone-wide mechanics in instance version 100 (no trash to summon)
...
function event_death_complete(e)
	-- Skip zone-wide signals in instance version 100
	if eq.get_zone_instance_version() == 100 then return; end
...
function event_combat(e)
	-- Skip zone-wide call-to-arms in instance version 100
	if eq.get_zone_instance_version() == 100 then return; end
	if (e.joined) then
