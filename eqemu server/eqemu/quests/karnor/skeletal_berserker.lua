...
-- skeletal_berserker (102120) Spawns #The_Fabled_Skeletal_Berserker (ID: 102130) exactly 15 seconds after death
...
function event_death_complete(e)
    ...
    if spawner and spawner.valid then
        spawner:CastToNPC():SetEntityVariable("fabled_id", "102130")
    end
end
