...
-- a_Drolvarg_warlord (102103) Spawns #The_Fabled_Drolvarg_Warlord (ID: 102128) exactly 15 seconds after death
...
function event_death_complete(e)
    ...
    if spawner and spawner.valid then
        spawner:CastToNPC():SetEntityVariable("fabled_id", "102128")
    end
end
