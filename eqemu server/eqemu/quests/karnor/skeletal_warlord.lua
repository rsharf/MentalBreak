...
-- skeletal_warlord (102008) Spawns #The_Fabled_Skeletal_Warlord (ID: 102132) exactly 15 seconds after death
...
function event_death_complete(e)
    ...
    if spawner and spawner.valid then
        spawner:CastToNPC():SetEntityVariable("fabled_id", "102132")
    end
end
