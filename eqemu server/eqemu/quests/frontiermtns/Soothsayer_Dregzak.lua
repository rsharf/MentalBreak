...
-- Soothsayer_Dregzak (92014) Spawns #The_Fabled_Soothsayer_Dregzak (ID: 92191) exactly 15 seconds after death
...
function event_death_complete(e)
    ...
    if spawner and spawner.valid then
        spawner:CastToNPC():SetEntityVariable("fabled_id", "92191")
    end
end
