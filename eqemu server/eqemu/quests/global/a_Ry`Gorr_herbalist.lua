...
-- #a_Ry`Gorr_herbalist (121006) Spawns #The_Fabled_Ry`Gorr_herbalist (ID: 121095) exactly 15 seconds after death
...
function event_death_complete(e)
    ...
    if spawner and spawner.valid then
        spawner:CastToNPC():SetEntityVariable("fabled_id", "121095")
    end
end
