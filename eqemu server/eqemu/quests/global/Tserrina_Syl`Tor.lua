...
-- #Tserrina_Syl`Tor (111154) Spawns #The_Fabled_Tserrina_Syl`Tor (ID: 111185) exactly 15 seconds after death
...
function event_death_complete(e)
    ...
    if spawner and spawner.valid then
        spawner:CastToNPC():SetEntityVariable("fabled_id", "111185")
    end
end
