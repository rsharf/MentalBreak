...
-- shardwurm_broodmother (118040) Spawns #The_Fabled_shardwurm_broodmother (ID: 118204) exactly 15 seconds after death
...
function event_death_complete(e)
    ...
    if spawner and spawner.valid then
        spawner:CastToNPC():SetEntityVariable("fabled_id", "118204")
    end
end
