...
-- shardwurm_matriarch (118104) Spawns #The_Fabled_shardwurm_matriarch (ID: 118205) exactly 15 seconds after death
...
function event_death_complete(e)
    ...
    if spawner and spawner.valid then
        spawner:CastToNPC():SetEntityVariable("fabled_id", "118205")
    end
end
