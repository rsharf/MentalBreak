...
-- incoherent_spirit (111059) Spawns #The_Fabled_incoherent_spirit (ID: 111179) exactly 15 seconds after death
...
function event_death_complete(e)
    ...
    if spawner and spawner.valid then
        spawner:CastToNPC():SetEntityVariable("fabled_id", "111179")
    end
end
