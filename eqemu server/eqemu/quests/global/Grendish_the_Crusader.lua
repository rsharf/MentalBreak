...
-- Grendish_the_Crusader (114245) Spawns The_Fabled_Grendish_the_Crusader (ID: 114587) exactly 15 seconds after death
...
function event_death_complete(e)
    ...
    if spawner and spawner.valid then
        spawner:CastToNPC():SetEntityVariable("fabled_id", "114587")
    end
end
