...
-- General_Jared_Blaystich (153095) Spawns The_Fabled_General_Jared_Blaystich (ID: 153148) exactly 15 seconds after death
...
function event_death_complete(e)
    ...
    if spawner and spawner.valid then
        spawner:CastToNPC():SetEntityVariable("fabled_id", "153148")
    end
end
