...
-- Solusek_kobold_king (32066) Spawns #The_Fabled_Solusek_Kobold_King (ID: 32081) exactly 15 seconds after death
...
function event_death_complete(e)
    ...
    if spawner and spawner.valid then
        spawner:CastToNPC():SetEntityVariable("fabled_id", "32081")
    end
end
