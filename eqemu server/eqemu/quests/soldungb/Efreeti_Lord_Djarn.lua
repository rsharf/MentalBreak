...
-- Efreeti_Lord_Djarn (32062) Spawns #The_Fabled_Efreeti_Lord_Djarn (ID: 32076) exactly 15 seconds after death
...
function event_death_complete(e)
    ...
    if spawner and spawner.valid then
        spawner:CastToNPC():SetEntityVariable("fabled_id", "32076")
    end
end
