...
extern void FilterSkillActivatedByClass();
...
void Heartbeat()
{
    ...
    // Filter combat skill Activated flags by character's class(es).
    // Runs every frame but no-ops after first successful filter for a given class mask.
