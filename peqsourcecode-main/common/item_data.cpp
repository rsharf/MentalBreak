...
bool EQ::ItemData::IsClassEquipableByMask(uint32 class_mask) const
{
	// Check if ANY class in the bitmask can equip this item.
	// class_mask uses bit (c-1) for class c, same encoding as item Classes field.
