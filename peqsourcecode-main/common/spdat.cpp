...
int GetPetSlotForSpell(uint16 spell_id)
{
	if (IsEffectInSpell(spell_id, SpellEffect::NecPet))
		return MultiPet::Slot_NecPet;
	if (IsEffectInSpell(spell_id, SpellEffect::SummonBSTPet))
		return MultiPet::Slot_BSTPet;
	return MultiPet::Slot_SummonPet; // SummonPet + Familiar default to slot 0
}
