...
int Perl_Client_GrantMulticlass(Client* self, uint8 class_id) // @categories Multiclass
{
	return self->GrantMulticlass(class_id);
}

bool Perl_Client_HasClass(Client* self, uint8 class_id) // @categories Multiclass
{
	return self->HasClass(class_id);
}

int Perl_Client_GetMulticlassCount(Client* self) // @categories Multiclass
{
	return self->GetMulticlassCount();
}

void Perl_Client_HydrateMulticlassFromDB(Client* self) // @categories Multiclass
{
	self->HydrateMulticlassFromDB();
}

uint32 Perl_Client_GetClassesMask(Client* self) // @categories Multiclass
{
	return self->GetClassesMask();
}
...
void perl_register_client()
{
	...
	package.add("GrantMulticlass", &Perl_Client_GrantMulticlass);
	package.add("HasClass", &Perl_Client_HasClass);
	package.add("GetMulticlassCount", &Perl_Client_GetMulticlassCount);
	package.add("HydrateMulticlassFromDB", &Perl_Client_HydrateMulticlassFromDB);
	package.add("GetClassesMask", &Perl_Client_GetClassesMask);
